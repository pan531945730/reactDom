...
import './stewardList.scss'
import Spinner from 'react-spinkit'
import { IndexLink, Link } from 'react-router'
import Nav from '../../../components/Nav'

export default class stewardList22 extends Component {
  componentDidMount () {
    const { fetchStewardList, stewardList11: { fetching, text } } = this.props
    fetchStewardList()
  ...
  render () {
    const {stewardList11: { fetching, text } } = this.props
    return (
      <div>
        <Nav />
              ...
              <Link to='/ProductView' className="pd-list" key={i.id}>
                ...
                <ul className="list-info">
                  ...
                  <li>
                    ...
                    <div className={i.status===0 && i.appTemplateType!=6 && i.appointment!=1? "circle":"hide"}>
...
stewardList22.propTypes = {
  stewardList11: PropTypes.object.isRequired
}
